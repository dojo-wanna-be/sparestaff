...
RSpec.describe "hirings/decline_request", type: :view do
  ...
  describe 'inboxes/hirer_decline-reservation-step-2-popup' do
	  it 'hirer decline request hiring step 1' do
	    render :partial => "inboxes/hirer_decline-reservation-step-2-popup", locals: {:@transaction => @transaction }
	      expect(rendered).to match /hirer_decline-reservation-step-2-popup/
	  end
	end
